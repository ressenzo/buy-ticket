...
using BuyTicket.Event.Test.Commons;

namespace BuyTicket.Event.Test.Entities;
...
public class EventTest
{
    ...
    {
        // Arrange - Act
        var @event = Domain.Entities.Event.Construct(_name,
            _description,
            _startDate,
            _endDate,
            _address);
    ...
    {
        // Arrange
        var @event = Domain.Entities.Event.Construct(name,
            _description,
            _startDate,
            _endDate,
            _address);
        ...
        @event.Errors.First().ShouldBe(Error.InvalidProperty(nameof(Domain.Entities.Event.Name)));
    }
    ...
    public void WhenDescriptionIsInvalid_ShouldReturnIsValidFalse(string description)
    {
        ...
        isValid.ShouldBeFalse();
        @event.Errors.ShouldHaveSingleItem();
        @event.Errors.First().ShouldBe(Error.InvalidProperty(nameof(Domain.Entities.Event.Description)));
    }
    ...
    public void WhenStartDateIsLessThanNow_ShouldReturnIsValidFalse()
    {
        ...
        isValid.ShouldBeFalse();
        @event.Errors.ShouldHaveSingleItem();
        @event.Errors.First().ShouldBe(Error.DateBeforeNow(nameof(Domain.Entities.Event.StartDate)));
    }
    ...
    public void WhenAddressIsNull_ShouldReturnIsValidFalse()
    {
        ...
        isValid.ShouldBeFalse();
        @event.Errors.ShouldHaveSingleItem();
        @event.Errors.First().ShouldBe(Error.NullProperty(nameof(Domain.Entities.Event.Address)));
    }
        ...
        string address)
    {
        ...
        isValid.ShouldBeFalse();
        @event.Errors.ShouldHaveSingleItem();
        @event.Errors.First().Message.ShouldContain(nameof(Domain.Entities.Event.Address));
    }
}
